const verifyEmailTemplate = (email: string, code: string | number): string => `<!doctype html>
<html lang="en">
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p style="margin-top:0px; padding-top:1rem">We received a request to verify your email address for your Lawyers Service App account.</p>
